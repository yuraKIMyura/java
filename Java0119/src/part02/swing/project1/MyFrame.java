...
public class MyFrame extends JFrame implements ActionListener{
	...
	public MyFrame() {
		...
		//현재 class가 instantiate 되면 '나'에 대해서 action을 해라
...
//JTextArea에 JScrollPane으로 scrollbar 추가		
