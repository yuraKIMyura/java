    ...
    <div class="container col-lg-11" style="background-color: #fefbe9; padding-bottom:5rem">
      ...
      <div class="row">
        ...
        <div class="col-lg-8" style="padding-right: 5rem">
          <h2 class="display-6" style="color: #ed7966; font-weight: bold; padding-bottom: 1rem">📦 전체게시판 </h2>

          <div style="padding-top:1rem; padding-bottom: 2rem;">
          
          <table class="table table-hover">
          	<thead style="background-color: #ed7966; color:#fefbe9">
                <tr>
                 <th scope="col">게시판</th>
                  <th scope="col">제목</th>
                  <th scope="col">작성자</th>
            ...
            <tbody>
            	<c:forEach var="board" items="${entireList}">
              <tr>
          ...
          <a class="btn btn-lg" href="writeForm.do" role="button" style="
