    ...
    <div class="container col-lg-11" style="background-color: #fefbe9; padding-bottom:5rem">
      ...
      <div class="row">
        ...
        <div class="col-lg-8" style="padding-right: 5rem">
          ...
          <div style="padding-top: 2rem; padding-bottom: 2rem;">
            ...
            <table class="table table-borderless">
              ...
              <tr>
                ...
                <td><input type="text" class="form-control" value="${member.id}" readonly></td>
              </tr>

              <tr>
                <td style="font-weight: bold; color: #183a1d;">이메일</td>
                <td><input type="text" class="form-control" value="${member.email}" name="email"></td>
              </tr>
              ...
              <tr>
                ...
                <td><input type="text" class="form-control" value="${member.question}" name="question"></td>
              </tr>

              <tr>
                <td style="font-weight: bold; color: #183a1d;">확인 질문 답</td>
                <td><input type="text" class="form-control" value="${member.answer}" name="answer"></td>
              </tr>
          ...
          ">완료</button>
            &nbsp;&nbsp;
            <a class="btn btn-lg" onclick='location.href="readInfoView.do"' role="button" style="
            background-color: #183a1da6;
            border: none;
            color: white;
          ">취소</a>
          </div>
