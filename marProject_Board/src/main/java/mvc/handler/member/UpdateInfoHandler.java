...
public class UpdateInfoHandler implements CommandHandler{
	...
	public String process(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		Member newInfoMember = new Member(id, email, name, question, answer);
		System.out.println("newInfoMember "+ newInfoMember.toString());
		int updateResult = memberDao.update(conn, newInfoMember);
