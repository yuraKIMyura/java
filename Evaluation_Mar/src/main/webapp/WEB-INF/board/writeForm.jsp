    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: #303179; font-weight:bold">
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="popularBoardView.html">인기</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="bestBoardView.html">베스트</a>
          </li>
    ...
    <div class="container col-lg-11" style="background-color: #fefbe9; padding-bottom:5rem">
      ...
      <div class="row">
        ...
        <div class="col-lg-8" style="padding-right: 5rem">
          ...
          <h2 class="display-6" style="color: #303179; font-weight: bold">글쓰기</h2>
 		...
 		<form action="write.do" method="post">
          <div style="padding-top: 2rem; padding-bottom: 2rem;">
            ...
            <table class="table table-borderless" style="color: #303179;">
              ...
              <tr>
                <td>내용</td>
                <td><textarea class="form-control" rows="20" name="content"> </textarea> </td>
              </tr>
            </table>
          </div>
