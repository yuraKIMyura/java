...
public class MemberDao {
	...
	public void insert(Member member) {
		//common approach used in JDBC to obtain auto-generated keys after an INSERT operation, especially when dealing with tables where primary keys are auto-incremented.
